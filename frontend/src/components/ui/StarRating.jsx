...
const StarRating = ({ rating, size = 'w-4 h-4', showRating = false }) => {
    ...
    <div className="flex items-center gap-0.5">
      ...
      {halfStar && (
        <svg 
          ...
          viewBox="0 0 20 20"
        >
          <path d="M10 15.273l-3.763 2.44.72-4.205-3.063-2.99 4.23-.615L10 6.1l1.876 3.803 4.23.615-3.063 2.99.72 4.205z"/>
        </svg>
      )}
      {showRating && (
